...
function setup() {
    ...
    xDir = 1;
    yDir = 1;
    shapey1 = new MovingShape(random(0,width),random(0,height),random(1,40));
    shapey2 = new MovingShape(random(0,width),random(0,height),random(1,40));
    circ = new MovingCircle(random(0,width),random(0,height),100);
